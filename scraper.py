...
_YUYU_MAP = {
    ...
    "EXSE": "EXシークレット", "RR": "ラッシュレア", "OR": "オーバーラッシュ",
    # カーナベル略称
    "GSE": "ゴールドシークレット", "ESE": "EXシークレット",
...
_RUSH_MAP = {
    ...
    "エクストラシークレット": "EXシークレット", "ラッシュレア": "ラッシュレア",
    ...
    "エクストラシークレットレア": "EXシークレット",
    "コレクターズレア": "コレクターズ",
    "グランドマスターレア": "グランドマスター", "グランドマスター": "グランドマスター",
    "オーバーフレームウルトラレア": "OFウルトラ", "オーバーフレームウルトラ": "OFウルトラ",
    "オーバーフレームプリズマティックシークレットレア": "OFプリシク",
    "オーバーフレームプリズマティックシークレット": "OFプリシク",
    "OFプリズマティックシークレット": "OFプリシク",
    "OFプリズマティックシークレットレア": "OFプリシク",
    "OFプリシク": "OFプリシク",
    "オーバーフレームプリシク": "OFプリシク",
    "オーバーフレームシークレットレア": "OFシークレット",
    "オーバーフレームシークレット": "OFシークレット",
    "OFシークレット": "OFシークレット",
    "オーバーフレームスーパーレア": "OFスーパー",
    "オーバーフレームスーパー": "OFスーパー",
    "OFスーパー": "OFスーパー",
    "ノーマルパラレルレア": "ノーマルパラレル",
    "ウルトラパラレルレア": "ウルトラパラレル",
